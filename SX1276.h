...
#define RF_MID_BAND_THRESH                          52500000
...
// Define of the addresses for PSK mode registers

#define REG_FIFO                                    0x00

// Addresses for common setting registers
...
// Addresses for the transmitter registers
#define REG_PACONFIG                                0x09
#define REG_PARAMP                                  0x0A
#define REG_OCP                                     0x0B

// Addresses for the receiver registers
#define REG_LNA                                     0x0C
...
// Addresses for the RC oscillator register
#define REG_OSC                                     0x24

// Addresses for packet handling registers
...
// Define of the possible value for FSK registers

// Values for common setting registers
// RegOpMode
...
// RegFdev (frequency deviation in Hz)
...
// RegFrf (carrier frequency in MHz)
...
// Values for the transmitter registers
// RegPaConfig
...
// RegOcp (overload current protection)
...
// Values for the receiver registers
// RegLna
...
// Values for the RC oscillator registers
// RegOsc
...
// Values for packet handling registers
...
// Values for additional registers
// RegPllHop
...
// Define of the addresses for LoRa mode registers
...
// Addresses for the RF blocks registers
#define REG_LR_PACONFIG                             0x09
#define REG_LR_PARAMP                               0x0A
#define REG_LR_OCP                                  0x0B
#define REG_LR_LNA                                  0x0C
// Addresses for the LoRa page registers
...
// Values for RF blocks registers
// RegPaConfig (third radio frequency power amplifier in the device)
...
// RegLna (first radio frequency amplifier of the device)
...
// Values for LoRa page registers
// RegFifoAddrPtr
...
{
	SX1276_state				State;
	SX1276_modemType			Modem;
    uint32_t					Channel;
    SX1276_FSKSettings			Fsk;
    SX1276_FSKPacketHandler 	FskPacketHandler;
    SX1276_LoRaSettings     	LoRa;
    SX1276_LoRaPacketHandler	LoRaPacketHandler;
}SX1276_set;
